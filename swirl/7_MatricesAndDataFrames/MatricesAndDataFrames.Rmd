---
title: "7. Matrices and Data Frames"
...
```{r}
 library(swirl)
```     
Acknowledgements: R Language Concepts and code questions (with some minor modifications) are used here from the swirl package. https://www.r-project.org/nosvn/pandoc/swirl.html
